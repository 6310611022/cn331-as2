...
class Course(models.Model):
    ...
    q_status = models.CharField(max_length=64, choices=[('Available', 'Available'), ('Full', 'Full')], default="Available")
...
class Student(models.Model):
    ...
    applys = models.ManyToManyField(Course, blank=True, related_name="student_apply")
